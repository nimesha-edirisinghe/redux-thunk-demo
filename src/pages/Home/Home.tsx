...
import { getVehiclesRequest } from 'store/vehicle/vehicleThunks';
...
const Home: FC = () => {
  ...
  useEffect(() => {
    const payload = { selectedBrand };
    dispatch(getVehiclesRequest(payload) as any);
  }, []);

  useEffect(() => {
    dispatch(getVehiclesRequest({ selectedBrand }) as any);
  }, [selectedBrand]);
